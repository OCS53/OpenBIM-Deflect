...
- 상세: [`backend/README.md`](backend/README.md) · [`docs/API.md`](docs/API.md)  
...
> **VTK** 히트맵·`localhost:3000` 단일 앱 UI는 로드맵 단계입니다. Redis/Celery 비동기 작업은 `POST /api/v1/jobs` 로 사용 가능합니다. [`docs/PROJECT-STRUCTURE.md`](docs/PROJECT-STRUCTURE.md) 참고.
